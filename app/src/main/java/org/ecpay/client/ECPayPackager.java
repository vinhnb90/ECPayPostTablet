...
/**
 * Created by NhatNV on Nov 27, 2014 16:45.
 */
public class ECPayPackager extends ISOBasePackager {
  protected ISOFieldPackager fld[] = {
    /*000*/ new IFA_NUMERIC(4, "MTI"),
    /*001*/ new IFA_BITMAP(16, "Bitmap"),
    /*002*/ new IFA_LLCHAR(15, "So dien thoai"),
    /*003*/ new IFA_NUMERIC(6, "Ma xu ly"),
    /*004*/ new IFA_NUMERIC(12, "So tien giao dich"),
    /*005*/ new IFA_NUMERIC(12, "So tien bi lock"),
    /*006*/ new IFA_NUMERIC(12, "So tien phi giao dich"),
    /*007*/ new IFA_NUMERIC(12, "So tien chiet khau cho giao dich"),
    /*008*/ new IFA_NUMERIC(12, "So du dau ky"),
    /*009*/ new IF_CHAR(20, "Conversion rate, Reconciliation"),
    /*010*/ new IFA_NUMERIC(8, "Conversion rate, Cardholder billing"),
    /*011*/ new IFA_NUMERIC(9, "AuditNumber Ma giao dich client gui len"),
    /*012*/ new IFA_NUMERIC(14, "yyyyMMddHHmmss Thoi gian request"),
    /*013*/ new IFA_NUMERIC(4, "Date, Effective"),
    /*014*/ new IFA_NUMERIC(4, "Date, Expiration"),
    /*015*/ new IFA_NUMERIC(14, "yyyyMMddHHmmss Thoi gian response"),
    /*016*/ new IFA_LLCHAR(99, "Ten khach hang eDong"),
    /*017*/ new IFA_LLNUM(12, "So chung minh thu khach hang eDong"),
    /*018*/ new IFA_LLCHAR(72, "Mat khau tai khoan vi"),
    /*019*/ new IF_CHAR(16, "Mat khau moi"),
    /*020*/ new IF_CHAR(16, "Mat khau nhap lai"),
    /*021*/ new IFA_NUMERIC(1, "Co yeu cau doi mat khau khi giao dich hay ko"),
    /*022*/ new IFA_NUMERIC(1, "Kenh thanh toan"),
    /*023*/ new IFA_LLNUM(15, "Ma hoa don thanh toan"),
    /*024*/ new IFA_LLCHAR(20, "Ma khach hang"),
    /*025*/ new IFA_NUMERIC(1, "Message reason code"),
    ...
    /*029*/ new IFA_LCHAR(9, "onetime password"),
    /*030*/ new IF_CHAR(36, "session-id"),
    /*031*/ new IFA_LLCHAR(99, "Acquirer reference data"),
    /*032*/ new IF_CHAR(6, "Ma doi tac Partner-Code"),
    /*033*/ new IF_CHAR(7, "Ma nha cung cap Provider-Code"),
    /*034*/ new IFA_LLCHAR(28, "Primary account number, extended"),
    /*035*/ new IFA_LLCHAR(37, "Track 2 data"),
    /*036*/ new IFA_LLLCHAR(320, "Description Thong tin mo ta"),
    /*037*/ new IF_CHAR(12, "Retrieval reference number"),
    /*038*/ new IFA_LLNUM(7, "Approval code"),
    /*039*/ new IF_CHAR(10, "Ma loi giao dich"),
    /*040*/ new IFA_NUMERIC(9, "Trace-Number Ma giao dich server gui tra ve"),
    ...
    /*047*/ new IFA_LLLCHAR(999, "Addition-Info Thong tin phu ve giao dich"),
    /*048*/ new IFA_LLLCHAR(999, "Response-Code-Detail Thong tin phu ve chi tiet ma loi"),
    /*049*/ new IF_CHAR(3, "Currency code, Transaction"),
    /*050*/ new IF_CHAR(32, "Signature chu ky dien tu xac thuc giao dich"),
    ...
    /*102*/ new IFA_LLCHAR(28, "AccountLoginResponse identification 1"),
    /*103*/ new IFA_LLCHAR(28, "AccountLoginResponse identification 2"),
