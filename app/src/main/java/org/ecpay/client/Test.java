...
/**
 * Created by NhatNV on Dec 03, 2014 12:05.
 */
public class Test {
...
//     msg = client.registerAccount("0977557078", "Đào Thị Thu", "111823333", pin1, pin2, (long) (Math.random() * 10E8));
    String pin = new String(Utils.encodeHex(crypto.encrypt(" ".getBytes())));
//    msg = client.login("0988310386", pin, (long) (Math.random() * 10E8));
