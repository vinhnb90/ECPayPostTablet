        ...
        if(billids.length > 0)
        {
            ...
            if (mCursor.moveToFirst()) {
                do {
                    ...
                    if (c != null && c.moveToFirst()) {
                        bill.setTEN_DIEN_LUC(c.getString(c.getColumnIndex("fullName")));
                    }
...
//                " and TRANG_THAI_TTOAN = '" + Common.TRANG_THAI_TTOAN.CHUA_TTOAN.getCode() + "'";// and status = " + ZERO;
    ...
    public void insertOrUpdateBillSearchOnline(String edong, BillInsideCustomer bodyBillResponse) {
        ...
        initialValues.put("THANG_TTOAN", Common.parse(Common.parseDate(Common.convertToDate(bodyBillResponse.getTerm()), Common.DATE_TIME_TYPE.ddMMyyyy.toString()), Common.DATE_TIME_TYPE.FULL.toString()));
