package views.ecpay.com.postabletecpay.util.libs.PopupMenu;
...
public class PopupMenu {
    ...
    public PopupMenu(Context context) {
        ...
        setContentView(mInflater.inflate(R.layout.lib_popup_menu, null));
    }
...
//        mPopupWindow.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.panel_background_popupmenu));
    }
    ...
    private class MenuItemAdapter extends ArrayAdapter<MenuItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.lib_menu_list_item, null);
